				...
				<div class="col-lg-4 mx-auto">
					<div class="auth-form-light text-left py-5 px-4 px-sm-5">
						...
						<form class="pt-3">
							...
							<div class="mt-3"><button class="btn btn-block btn-muted btn-lg font-weight-medium auth-form-btn" type="button" onclick="location.href='/main'">사용자모드</button></div>
						</form>
					</div>
				</div>
			</div>
...
async function doLogin(){
    try {
        ...
        let res = await awaitPost('/mng/login.do', params, false);   
		console.log(res);
